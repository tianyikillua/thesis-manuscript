...
\subsection{Lagrangian Description in the Initial Cracked Configuration} \label{sec:initialconfiguration}
...
\subsection{Reformulation Based on a Space-Time Action Integral} \label{sec:reformulationtheta}
