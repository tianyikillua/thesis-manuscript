...
By virtue of \eqref{eq:grad} and \eqref{eq:v}, we can thus rewrite the energetic quantities in the initial configuration. The elastic energy is thus given by
