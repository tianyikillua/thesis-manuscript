...
(G_t-\gc)\dot{l}_t=0
\]
can then be derived thanks to the energy balance principle \eqref{eq:eb} and calculations in Appendix \ref{sec:ebcalc}. The combination of these two conditions along with the irreversiblity condition leads to the desired Griffith's law of crack propagation \eqref{eq:gtgc}.
...
The present work leads to the publication of the following articles:
\begin{itemize}
\item \fullcite{Li:2016aa}
\item \fullcite{LiMarigo:2016}
\item \fullcite{LiMarigoGuilbaudPotapov:2016}
\item \fullcite{LiMarigoGuilbaudPotapov:2015}
\end{itemize}
