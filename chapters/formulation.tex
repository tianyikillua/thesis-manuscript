...
\begin{equation} \label{eq:damageinitiationsound2}
...
\end{equation}
This quantity contains the conventional dynamic energy release rate\index{energy release rate!conventional dynamic energy release rate}
...
\end{equation}
and the damage dissipation rate\index{energy release rate!damage dissipation rate} as the partial derivative of the damage dissipation energy $\mathcal{S}^*(l_t)$ with respect to the crack length
...
It remains to use the energy balance \eqref{eq:dyngdeb3} to derive the consistency conditions. With the help of calculations given in Appendix \ref{sec:ebcalc}, we obtain
