...
The field $\vec{U}_t\in\mathcal{C}_t$ should be understood as a \emph{lift} of the Dirichlet boundary condition classically defined only on $\partial\Omega_U$.
\end{remark}
