...
Licensees may copy, distribute, display and perform the work and make derivative works and remixes based on it only if they give the author the credits (attribution) similar to
\begin{quotation}
\fullcite{Li:2016}. \mybibexclude{Li:2016}
\end{quotation}

The following BiBTeX source code can be used:
\begin{mdframed}[hidealllines=true,backgroundcolor=gray!20]
\begin{lstlisting}[breaklines,extendedchars=false,inputencoding=utf8,basicstyle=\ttfamily]
@PhdThesis{Li:2016,
  author = {Tianyi Li},
